...
You can either use `[global_tags]` or using a more advanced configuration as documented [here](https://github.com/DeadlyCrush/telegraf/blob/master/docs/CONFIGURATION.md).
